...
### Integration Testing
This project includes a set of Pester tests to ensure the basic functionality of this module. To run the tests, you must have Pester version 4.x or higher installed on the machine.

Run `Test-ADFSDiagnostics.ps1`. This will automatically enumerate and run all of the Pester tests within the Test folder.

Additionally, you can use `Test-ADFSDiagnostics.ps1 -CodeCoverage` to preform code coverage.
